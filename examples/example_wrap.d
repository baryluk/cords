...
void main() {
	...
	auto porg = Cord("The quick brown fox jumps over the lazy dog\n");
...
//	assert(p4[16 .. 19] == "bat");
	...
	assert(pp.length == 2_952_790_016);

	// Substring of large text

	auto x = pp[ 387_612_123 .. 597_115_123 ];

	assert(x.length == 209_503_000);

	auto y = pp[ 17_612_123 .. 17_613_612 ];
